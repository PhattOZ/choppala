      ...
      <footer>
        <nav className={styles.footernav}>
          <div className={styles.footercol}>
            <Link href="/">
              <h5 class={styles.title}>CUSTOMER SERVICE</h5>
            </Link>
          ...
          <div className={styles.footercol}>
            <Link href="/">
              <h5 class={styles.title}>CHOPPALA</h5>
            </Link>
            <ul className={styles.ul}>
              <li>
                <Link href="/">
          ...
          <div className={styles.footercol}>
            <Link href="/">
              <h5 class={styles.title}>PAYMENT</h5>
            </Link>
            <svg
          ...
          <div className={styles.footercol}>
            <Link href="/">
              <h5 class={styles.title}>FOLLOW US</h5>
            </Link>
            ...
            <a href="https://twitter.com/?lang=th" target="_blank">
              <svg
                className={styles.icon}
                xmlns="http://www.w3.org/2000/svg"
                width="20"
          ...
          <div className={styles.footercol}>
            <Link href="/">
              <h5 class={styles.title}>APP COMING SOON!</h5>
            </Link>
